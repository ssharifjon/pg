...
```
### Note
if you want a simpler version of the script without external files, and without displaying of the file sizes, checkout branch `main`. If you want to use it with non-GNU version of `find`, checkout branch `ksh`.
